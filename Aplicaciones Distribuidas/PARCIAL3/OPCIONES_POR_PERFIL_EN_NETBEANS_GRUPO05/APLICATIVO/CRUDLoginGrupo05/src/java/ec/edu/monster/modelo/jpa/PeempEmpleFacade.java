...
public class PeempEmpleFacade extends AbstractFacade<PeempEmple> {
    ...
    public List<PeempEmple> findAllEmple() {
        List<PeempEmple> empleList = findAll();
        return (empleList != null) ? empleList : new ArrayList<>();
    }
    
    public List<PeempEmple> findByTeproCodigo(Integer teproCodigo){
        try {
            TypedQuery<PeempEmple> query = em.createNamedQuery("PeempEmple.findByTeproCodigo", PeempEmple.class);
            query.setParameter("teproCodigo", teproCodigo);
