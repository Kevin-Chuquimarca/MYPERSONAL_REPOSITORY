...
public class PdfReport {
    ...
    private static final String path = "C:\\FORMULARIOS_CHUQUIMARCA\\PARCIAL3\\SISTEMA EN JAVA\\04. PROTOTIPO\\CRUDLoginGrupo05\\reportes\\";
    private static final String fileName = "reporte" + new Date().getTime() + ".pdf";
...
//            document.add(logoImage);
            ...
            document.add(new Paragraph("GRUPO 05: REPORTE DE EMPLEADOS", titleFont));
