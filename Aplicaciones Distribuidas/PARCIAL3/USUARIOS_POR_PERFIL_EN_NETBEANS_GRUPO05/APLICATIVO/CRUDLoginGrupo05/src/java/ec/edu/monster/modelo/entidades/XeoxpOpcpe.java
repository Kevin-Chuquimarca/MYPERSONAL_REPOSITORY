...
@NamedQueries({
    ...
    @NamedQuery(name = "XeoxpOpcpe.findByXeopcCodigoAndXeperCodigo", query = "SELECT x FROM XeoxpOpcpe x WHERE x.xeoxpOpcpePK.xeopcCodigo = :xeopcCodigo AND x.xeoxpOpcpePK.xeperCodigo = :xeperCodigo")})
public class XeoxpOpcpe implements Serializable {
    ...
    public XeoxpOpcpe(String xeopcCodigo, String xeperCodigo, Date xeoxpFecasi) {
        this.xeoxpOpcpePK = new XeoxpOpcpePK(xeopcCodigo, xeperCodigo, xeoxpFecasi);
    }
    ...
    public String toString() {
        return "ec.edu.monster.modelo.entidades.XeoxpOpcpe[ xeoxpOpcpePK=" + xeoxpOpcpePK + " ]";
    }
