...
import ec.edu.monster.modelo.jpa.XeusuUsuarFacade;
...
public class XeusuUsuarController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.modelo.jpa.XeusuUsuarFacade ejbFacade;
    ...
    public XeusuUsuar getCurrent() {
        return current;
    }

    public void setCurrent(XeusuUsuar current) {
    ...
    public static class XeusuUsuarControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof XeusuUsuar) {
                ...
                return getStringKey(o.getXeusuPaswd());
            } else {
